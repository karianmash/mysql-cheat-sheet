...
-- -------------------------------------------------------------------------------------------------
-- (i) Select * from the table where salary > 2000 and age < 30.
SELECT
    *
FROM
    mytable
...
-- -------------------------------------------------------------------------------------------------
-- (j) Select * from the table where salary > 2000 or age < 30.
SELECT
    *
FROM
    mytable
...
-- -------------------------------------------------------------------------------------------------
-- (k) Select * from the table where salary > 2000 or age < 30 and name = 'Ramesh'.
SELECT
    *
FROM
    mytable
